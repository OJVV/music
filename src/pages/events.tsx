  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-[40vh] overflow-hidden">
        <img 
          src="https://img.heroui.chat/image/ai?w=1920&h=600&u=techno-party-wide" 
          alt="Events" 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="relative aspect-square overflow-hidden rounded-md">
              <img 
                src="https://img.heroui.chat/image/ai?w=600&h=600&u=past-event-1" 
                alt="Past Event" 
            ...
            <div className="relative aspect-square overflow-hidden rounded-md">
              <img 
                src="https://img.heroui.chat/image/ai?w=600&h=600&u=past-event-2" 
                alt="Past Event" 
                className="w-full h-full object-cover"
              />
              <div className="absolute inset-0 bg-black/60 flex items-end p-4">
            ...
            <div className="relative aspect-square overflow-hidden rounded-md">
              <img 
                src="https://img.heroui.chat/image/ai?w=600&h=600&u=past-event-3" 
                alt="Past Event" 
                className="w-full h-full object-cover"
              />
              <div className="absolute inset-0 bg-black/60 flex items-end p-4">
            ...
            <div className="relative aspect-square overflow-hidden rounded-md">
              <img 
                src="https://img.heroui.chat/image/ai?w=600&h=600&u=past-event-4" 
                alt="Past Event" 
                className="w-full h-full object-cover"
              />
              <div className="absolute inset-0 bg-black/60 flex items-end p-4">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden">
              <img 
                src="https://img.heroui.chat/image/ai?w=800&h=800&u=club-venue" 
                alt="Club Venue" 
                className="w-full h-full object-cover"
              />
            </div>
