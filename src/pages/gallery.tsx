  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-[40vh] overflow-hidden">
        <img 
          src="https://img.heroui.chat/image/ai?w=1920&h=600&u=techno-party-gallery-wide" 
          alt="Gallery" 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <motion.div 
              ...
              onClick={() => handleImageClick("https://img.heroui.chat/image/ai?w=800&h=1200&u=techno-party-flyer-1")}
            >
              <img 
                src="https://img.heroui.chat/image/ai?w=800&h=1200&u=techno-party-flyer-1" 
                alt="Event Flyer" 
            ...
            <motion.div 
              ...
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.3 }}
              onClick={() => handleImageClick("https://img.heroui.chat/image/ai?w=800&h=1200&u=deep-house-party-flyer")}
            >
              <img 
                src="https://img.heroui.chat/image/ai?w=800&h=1200&u=deep-house-party-flyer" 
                alt="Event Flyer" 
                className="w-full h-full object-cover"
              />
            </motion.div>
            ...
            <motion.div 
              ...
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.3 }}
              onClick={() => handleImageClick("https://img.heroui.chat/image/ai?w=800&h=1200&u=techno-underground-flyer")}
            >
              <img 
                src="https://img.heroui.chat/image/ai?w=800&h=1200&u=techno-underground-flyer" 
                alt="Event Flyer" 
                className="w-full h-full object-cover"
              />
            </motion.div>
            ...
            <motion.div 
              ...
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.3 }}
              onClick={() => handleImageClick("https://img.heroui.chat/image/ai?w=800&h=1200&u=beach-party-flyer")}
            >
              <img 
                src="https://img.heroui.chat/image/ai?w=800&h=1200&u=beach-party-flyer" 
                alt="Event Flyer" 
                className="w-full h-full object-cover"
              />
            </motion.div>
